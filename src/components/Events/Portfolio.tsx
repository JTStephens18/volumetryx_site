...
import ArtPieceImage from '../../assets/ArtPiece.png';
import HolidayImage from '../../assets/HolidayDesign.png';
import WinterGardenImage from '../../assets/WinterGarden.png';
      ...
      <div className="max-w-7xl mx-auto px-6">
        <div className="text-center mb-16">
          ...
          <p className="text-xl text-gray-600 max-w-3xl mx-auto">
            Step inside our portfolio of stunning 3D experiences that have transformed how clients connect with spaces.
          </p>
        </div>
