  ...
  const packages = [
    {
      ...
      description: "Ideal for standard venues or single design concepts",
      features: [
        "Up to 2,500 sq ft",
    ...
    },
    {
      ...
      price: "$799", 
      subtitle: "Starting at",
      description: "The complete package to market your venue or design across all digital channels.",
      features: [
        "Up to 3,500 sq ft",
        "Everything in Digital Showcase, plus:",
    ...
    },
    {
      ...
      price: "Custom Quote",
      subtitle: "",
      description: "For large venues, unique requirements, or specialized design projects.",
      features: [
        ...
        "Digital Twin File for internal planning",
      ],
      popular: false,
