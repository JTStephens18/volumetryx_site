  ...
  <section id="home" className="relative min-h-screen flex items-center justify-center overflow-hidden bg-gradient-to-br from-slate-50 to-blue-50">
      ...
      <div className="relative z-10 text-center max-w-4xl mx-auto px-6">
        <h1 className="text-5xl md:text-7xl text-gray-900 mb-6 leading-tight">
          ...
          <span className="text-blue-600">One Scan.</span> Every Asset for Sales and Design.
        </h1>
        ...
        <p className="text-xl md:text-2xl text-gray-600 mb-16 max-w-2xl mx-auto">
          ...
          Transform your venue or design space into a photorealistic Digital Twin that generates every sales and design asset you need. Get your immersive virtual tour, high-definition photos, video fly-throughs, and accurate floor plans from a single, streamlined appointment.
        </p>
        ...
        <div className="relative">
          ...
          <iframe id="viewer" className="w-full h-full rounded-lg" allow="fullscreen; xr-spatial-tracking" src="https://superspl.at/s?id=88648ea9"></iframe>
          </div>
        </div>
        {/* <button 
