        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-start">
          ...
          <div>
            <h2 className="text-4xl md:text-5xl text-gray-900 mb-8">
              Ready to Share Your Collection with the World?
            </h2>
            <p className="text-xl text-gray-600 mb-8">
              Let's discuss how Volumetryx Labs can safeguard your artifacts and transform your institutional engagement for generations to come.
            </p>
            ...
            <div className="space-y-6">
              <div>
                ...
                <ul className="space-y-2 text-gray-600">
                  <li>• Free consultation and collection assessment</li>
                  <li>• Custom quote based on your specific archival and outreach goals</li>
          ...
          <div className="bg-gray-50 rounded-2xl p-8">
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <div>
                <Label htmlFor="propertyType">Artifact Type</Label>
                <Input
                  id="propertyType"
                  name="propertyType"
                  type="text"
