                ...
                <div className="space-y-4">
                  <div className="aspect-video bg-gradient-to-br from-blue-500/20 to-purple-600/20 rounded-lg flex items-center justify-center">
                    <div className="text-center">
                      ...
                      <p className="text-gray-700">Interactive 3D Model</p>
                      <p className="text-sm text-gray-500">Click and drag to explore</p>
                    </div>
                  </div>
                  <div>
                    ...
                    <p className="text-gray-600 mb-2">{project.location} • {project.size}</p>
