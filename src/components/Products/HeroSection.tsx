  ...
  <section id="home" className="relative min-h-screen flex items-center justify-center overflow-hidden bg-gradient-to-br from-slate-50 to-blue-50">
      ...
      <div className="relative z-10 text-center max-w-4xl mx-auto px-6">
        <h1 className="text-5xl md:text-7xl text-gray-900 mb-6 leading-tight">
          ...
          <span className="text-blue-600">One Capture.</span> Every Digital Asset.
        </h1>
        ...
        <p className="text-xl md:text-2xl text-gray-600 mb-16 max-w-2xl mx-auto">
          ...
          Transform physical products into a photorealistic digital twin that generates every asset you need. Get your 3D model, high-resolution product shots, web-optimized viewers, and technical specs from a single, efficient capture session.
        </p>
        ...
        <div className="relative">
          ...
          <iframe id="viewer" className="w-full h-full rounded-lg" allow="fullscreen; xr-spatial-tracking" src="https://superspl.at/s?id=461f077e"></iframe>
          </div>
        </div>
        {/* <button 
